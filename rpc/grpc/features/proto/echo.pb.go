...
func init() {
	proto.RegisterType((*EchoRequest)(nil), "featuresProto.EchoRequest")
	proto.RegisterType((*EchoResponse)(nil), "featuresProto.EchoResponse")
}
...
var fileDescriptor_08134aea513e0001 = []byte{
	...
	0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4d, 0x4b, 0x4d, 0x2c, 0x29, 0x2d, 0x4a, 0x2d,
	0x0e, 0x00, 0x71, 0x95, 0xd4, 0xb9, 0xb8, 0x5d, 0x93, 0x33, 0xf2, 0x83, 0x52, 0x0b, 0x4b, 0x53,
	...
	0xe2, 0x54, 0xdc, 0x2a, 0x8d, 0x2e, 0x33, 0x71, 0xb1, 0x80, 0x94, 0x0a, 0xb9, 0x71, 0x71, 0x86,
	0xe6, 0x25, 0x16, 0x55, 0x82, 0x39, 0x52, 0x7a, 0x28, 0x16, 0xeb, 0x21, 0xd9, 0x2a, 0x25, 0x8d,
	0x55, 0x0e, 0x62, 0x91, 0x12, 0x83, 0x50, 0x10, 0x97, 0x70, 0x70, 0x6a, 0x51, 0x59, 0x6a, 0x51,
	0x70, 0x49, 0x51, 0x6a, 0x62, 0x6e, 0x66, 0x5e, 0x3a, 0x85, 0x26, 0x1a, 0x30, 0x82, 0xcc, 0x74,
	0xce, 0xc9, 0x4c, 0xcd, 0x2b, 0xa1, 0x96, 0x99, 0x1a, 0x8c, 0x42, 0xd1, 0x5c, 0x52, 0x4e, 0x99,
	0x29, 0x99, 0x45, 0xa9, 0xc9, 0x25, 0x99, 0xf9, 0x79, 0x89, 0x39, 0xd4, 0x33, 0xda, 0x80, 0x31,
	0x89, 0x0d, 0x1c, 0x7d, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc2, 0x7c, 0x8c, 0xea, 0xcc,
	0x01, 0x00, 0x00,
}
...
func (c *echoClient) UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/featuresProto.Echo/UnaryEcho", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *echoClient) ServerStreamingEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (Echo_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[0], "/featuresProto.Echo/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[1], "/featuresProto.Echo/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoClient) BidirectionalStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[2], "/featuresProto.Echo/BidirectionalStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func _Echo_UnaryEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/featuresProto.Echo/UnaryEcho",
	}
...
var _Echo_serviceDesc = grpc.ServiceDesc{
	ServiceName: "featuresProto.Echo",
