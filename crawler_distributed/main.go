...
var (
	itemSaverHost = flag.String("itemsaver_host", ":1234", "itemsaver host (eg: :1234)")
	workerHosts   = flag.String("worker_hosts", ":9000", "worker hosts (comma separated, eg: :9001,:9002)")
)
...
func main() {
	...
	process := worker.CreateProcessor(pool)
